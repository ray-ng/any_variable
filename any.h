...
template <typename T>
class Any::HeapCopy<true, T> {
 public:
  inline static void create_from_data(Any::Data *dst, const Any::Data &data) {
    dst->pheap = new T(*Any::TypeOnHeap<T>::get_ptr(&data));
  }
};

template <typename T>
class Any::TypeOnHeap : public Any::HeapCopy<std::is_copy_constructible<T>::value, T> {
 public:
...
template <typename T>
class Any::StackCopy<true, T> {
 public:
  inline static void create_from_data(Any::Data *dst, const Any::Data &data) {
    new (&(dst->stack)) T(*Any::TypeOnStack<T>::get_ptr(&data));
  }
};

template <typename T>
class Any::TypeOnStack : public Any::StackCopy<std::is_copy_constructible<T>::value, T> {
 public:
  inline static const T *get_ptr(const Any::Data *data) {
...
template <typename T>
class Any::TypeInfo
    : public std::conditional<Any::data_on_stack<T>::value, Any::TypeOnStack<T>, Any::TypeOnHeap<T>>::type {
 public:
